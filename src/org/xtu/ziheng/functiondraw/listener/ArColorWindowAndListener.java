...
public class ArColorWindowAndListener implements ActionListener {
	JRadioButton button;
	JDialog dialog;
	Container container;
	JButton jButton;
	...
	public ArColorWindowAndListener() {
		// TODO Auto-generated constructor stub
		dialog = new JDialog(FunctionDrawUI.getInstance(), "坐标轴及刻度颜色设置", true);
		dialog.setLayout(new FlowLayout(FlowLayout.CENTER,10,10));
		container = dialog.getContentPane();
		
		jLabel = new JLabel("坐标轴及刻度颜色设置");
