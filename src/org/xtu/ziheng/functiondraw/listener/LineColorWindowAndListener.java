...
public class LineColorWindowAndListener implements ActionListener {
	JRadioButton button;
	JDialog dialog;
	Container container;
	JButton jButton;
	...
	public LineColorWindowAndListener() {
		// TODO Auto-generated constructor stub
		dialog = new JDialog(FunctionDrawUI.getInstance(), "函数线颜色设置", true);
		dialog.setLayout(new FlowLayout(FlowLayout.CENTER,10,10));
		container = dialog.getContentPane();
		
		jLabel = new JLabel("函数线颜色设置");
